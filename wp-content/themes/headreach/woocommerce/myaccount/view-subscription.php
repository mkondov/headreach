					...
					<tr>
						...
						<td>
							...
							<?php if ( $key == 'cancel' ) : ?>
								...
								<a data-open="popup-cancel" data-href="<?php echo esc_url( $action['url'] ); ?>" class="button <?php echo sanitize_html_class( $key ) ?>"><?php echo esc_html( $action['name'] ); ?></a>
...
<div class="reveal" id="popup-cancel" data-reveal>
	<h4>Cancel my subscription</h4>

	<form accept-charset="UTF-8" action="#" method="post">
		<div class="modal-body">
			<p><strong>We're sorry to see you go.</strong></p>
			<p>Why are you cancelling your subscription? Please help us by providing your honest feedback:</p>
			
			<p>
				<input name="has_finished" type="checkbox" class="checkbox" value="true">
				<label>I finished the work I needed to do</label>
			</p>

			<p>
				<input name="another_tool" type="checkbox" class="checkbox" value="true">
				<label>I switched to another tool</label>
			</p>

			<p>
				<input name="low_data_quality" type="checkbox" class="checkbox" value="true">
				<label>The data quality is too low</label>
			</p>

			<p>
				<input name="missing_feature" type="checkbox" class="checkbox" value="true">
				<label>A feature is missing</label>
			</p>

			<p>
				<input name="too_expensive" type="checkbox" class="checkbox" value="true">
				<label>HeadReach is too expensive</label>
			</p>

			<!-- <p>
				<input name="joining_another_team" type="checkbox" value="true">
				<label>I'm joining another team with a subscription</label>
			</p> -->

			<p>
				<textarea class="form-control" name="explanation" placeholder="Tell us more about why you're cancelling your subscription." rows="3"></textarea>
			</p>

			<div class="callout-admin">
				<p>Please choose your reason for cancellation</p>
			</div>

		</div>
		<div class="modal-footer">
			<br><input class="button alert hollow" type="submit" value="Cancel my subscription">
		</div>
	</form>
