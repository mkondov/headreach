...
def makeJsRequest(p_num,cookiej):
    ...
    #     js_url = "https://www.linkedin.com/vsearch/pj?firstName=" + first_name + "&lastName="+ last_name +"&page_num="+str(p_num)+"&openAdvancedForm=true&locationType=Y"
    #elif first_name == None:
    #     js_url = "https://www.linkedin.com/vsearch/pj?lastName=" + last_name +"&page_num="+str(p_num)+"&openAdvancedForm=true&locationType=Y"
    #else:
    #    js_url = "https://www.linkedin.com/vsearch/pj?firstName=" + first_name + "&page_num="+str(p_num)+"&openAdvancedForm=true&locationType=Y"
    js_url = "https://www.linkedin.com/vsearch/pj?firstName=" + first_name + "&lastName="+ last_name +"&page_num="+str(p_num)+"&openAdvancedForm=true&companyScope=C&locationType=Y"
...
first_name_arg = sys.argv[1]
last_name_arg = sys.argv[2]
